...
<!-- 로그인 시작 { -->
<div id="mb_login" class="mbskin mb-5">
    <div class="mbskin_box text-center">
   
        <form name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
        <input type="hidden" name="url" value="<?php echo $login_url ?>">
        
        <fieldset id="login_fs" >
            <legend class="logintitle mb-3">회원로그인</legend>
            <div >
                <p class='d-flex  justify-content-center'>
                <label for="login_id" class='logintxt col-4 pe-3 mt-2'>아이디<strong class="sound_only"> 필수</strong></label>
                <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20" >
                
                </p>
                <p class='d-flex justify-content-center'>
                <label for="login_pw"  class='logintxt col-4 mt-2' >비밀번호<strong class="sound_only"> 필수</strong></label>
            ...
            <button type="submit" class="loginbutton btn_submit w-100 bg-black text-white">로그인</button>
            
            <div id="login_info" class='d-flex justify-content-between align-items-center'>
                <div class="login_if_auto chk_box">
                    <input type="checkbox" name="auto_login" id="login_auto_login" class="selec_chk">
                    <label for="login_auto_login"><span></span> 자동로그인</label>  
                </div>
                
                <a href="<?php echo G5_BBS_URL ?>/password_lost.php" class='ms-auto'>아이디/비밀번호 찾기</a>  
